...
- [Performance Evolution](performance.md) — Optimization journey across fio-cdm, real-world sequential reads, metadata workloads, compound operations, and dead ends (DirectMap, readdirplus)
